...
int main(int argc, char *argv[]) {
	...
	/* build post data */
	json_object_object_add(json, "title", json_object_new_string("test"));
	json_object_object_add(json, "body", json_object_new_string("test json and curl from c."));
	json_object_object_add(json, "userId", json_object_new_int(56));
